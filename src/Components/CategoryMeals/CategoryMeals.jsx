...
export default function CategoryMeals() {
    ...
    function getcatMeals(catName){
        return axios.get(`https://www.themealdb.com/api/json/v1/1/filter.php?c=${catName}`)
    }

    let {data , isLoading} = useQuery('getCatMeals', ()=> getcatMeals(params.catName));
